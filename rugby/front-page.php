    ...
    <div class="row">
      <div class="col-lg-8 col-md-12 col-sm-12 map">
        <div class="inner_map">
          ...
          <!-- <a href="" class="waterdrop one animated1 fadeInDown" data-toggle="modal" data-target="#sapporastad"><img src="<?php echo get_template_directory_uri(); ?>/img/pin-1.png" alt=""></a> -->
        </div>
      </div>
        ...
        <section id="postsCarousel">
          ...
          <div class="col-12 ">
            ...
            <div class="success-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/13.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Eat out at a yokocho</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Mirai Yokochoa</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#venumirai">MORE</a>
                </div>
              </div>
            </div>
            <div class="danger-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/8.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>See worlds collide through art</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Yokohama Museum of Art</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#venumuse">MORE</a>
                </div>
              </div>
            </div>
            <div class="success-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/30.png" class="img-fluid" alt=""></div>
                <div>
                  <h3>Shop in the sea breeze</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Marine & Walk Yokohama</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#venumarine">MORE</a>
                </div>
              </div>
            </div>
            <div class="danger-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/9.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Kick off your rugby night</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Rugby Diner 7 oath's</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#venurugby7">MORE</a>
                </div>
              </div>
            </div> 
            <div class="success-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/saitama_031.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Drive the shinkansen</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">The Railway Museum</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#rail">MORE</a>
                </div>
              </div>
            </div>
            <div class="danger-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/saitama_040.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Opt for a wilder view</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Chichibu Geo Gravity Park</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#geo">MORE</a>
                </div>
              </div>
            </div>
            <div class="success-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/saitama_009.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Enjoy the big game over dinner</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Teppachi Hakkai</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#hakkai">MORE</a>
                </div>
              </div>
            </div>
            <div class="danger-box_cvenue">
              <div class="venu_grid">
                <div class="venu_img"><img src="/wp-content/uploads/2019/05/saitama_025.jpg" class="img-fluid" alt=""></div>
                <div>
                  <h3>Meet the Moomins</h3>
                  <p><img src="<?php echo get_theme_file_uri('/img/location_icon2x.png');?>" alt="">Moomin Valley Park</p>
                  <a href="" class="more_btn" data-toggle="modal" data-target="#valley">MORE</a>
                </div>
              </div>
            </div>
          </div>
